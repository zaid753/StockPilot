...
interface InventoryContextType {
    ...
    loading: boolean;
    salesBucket: { item: InventoryItem; soldQty: number }[];
    setSalesBucket: React.Dispatch<React.SetStateAction<{ item: InventoryItem; soldQty: number }[]>>;
}
...
export const InventoryProvider: React.FC<{ children: ReactNode; userId: string }> = ({ children, userId }) => {
    ...
    const value = { inventory, loading, salesBucket, setSalesBucket };
